...
export default function Targets() {
    ...
    return (
	    ...
	    <EditableTable
            ...
            />
            <Button variant="light" onClick={() => setCreatingNew(true)}>
                {" "}
                <h3>
                    {" "}
                    ...
                    {({ errors, submitForm }) => (
                        <>
                            <Modal.Header closeButton>
                                <Modal.Title>Create a new target</Modal.Title>
                            </Modal.Header>
                            <Modal.Body>
                                <Formik.Form as={BS.Form}>
                                    <BS.Form.Group className="mb-3">
                                        <BS.Form.Label>Target</BS.Form.Label>
                                        <Formik.Field
                                            name="target"
                                            as={BS.Form.Control}
                                    ...
                                    <BS.Form.Group
                                        ...
                                        controlId="formRegex"
                                    >
                                        <BS.Form.Label>Regex</BS.Form.Label>
                                        <Formik.Field
                                        ...
                                        />
                                        <BS.Form.Control.Feedback type="invalid">{`${errors.regex}`}</BS.Form.Control.Feedback>
                                    </BS.Form.Group>
                                    <BS.Form.Group>
                                        <BS.Form.Control
